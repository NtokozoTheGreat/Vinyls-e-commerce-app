...
urlpatterns = [
    ...
    path('update_store/', views.become_vendor, name='update_store'),
    path('remove_store/', views.delete_store, name='remove_store'),
    path('update_user/', views.update_user, name='update_user'),
    path('update_info/', views.update_info, name='update_info'),
    path('update_password/', views.update_password, name='update_password'),
    path('vendor/', views.vendor_dashboard, name='vendor'),
    path('add_product/', views.add_product, name='add_product'),
    path('update_product/', views.edit_product, name='update_product'),
    path('remove_product/', views.delete_product, name='remove_product'),
